export default function SubscriptionDetail({ isPremium = false, remainingActiveDays, activeDays }) {
    ...
    return <> {isPremium ? <><div className="mt-auto pr-[30px]">
